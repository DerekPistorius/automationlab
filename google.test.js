...
test('I can search Google', async () => {
    ...
    searchBar = await driver.findElement(By.css('[name="q"]'))

    // We'll use this line to clear out our old input.
    await driver.findElement(By.css('[name="q"]')).clear() 

    // Let's do another search!
    await driver.findElement(By.css('[name="q"]')).sendKeys('nfl\n')
